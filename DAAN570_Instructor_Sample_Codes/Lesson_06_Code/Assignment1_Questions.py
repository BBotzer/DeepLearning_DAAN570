...
#%%
#Deal with the class imbalance if needed
...
plot_model(model, to_file='Diabetes_Model_test.png')
...
#%%
quick_plot(values, list(values.history.keys()),"Batch=128, lr=0.001, epochs=120, activ=relu/sigmoid")
...
plot_model(model, to_file='Diabetes_Model_v2_test.png')
...
#%%
quick_plot(values_v2, list(values_v2.history.keys()),"test")
...
values_v2 = model.fit(X_train, y_train, batch_size=128, epochs=100, verbose=1)
